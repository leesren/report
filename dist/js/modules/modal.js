...
;(function(window){
  ...
  EffecktModal.prototype.init = function(parentEl,el) {
    this.$body                = $('body');
    this.$element             = null;
    this.$overlay             = null;
    this.isShown              = false;
    ...
    this.currentEl = el;
    // this.bindUIActions();
    this.bindUIActionsDIY(parentEl,el);
  };
  /*绑定UI*/
  EffecktModal.prototype.bindUIActionsDIY = function(parentEl,el) {
  $(parentEl).on( Effeckt.buttonPressedEvent,
                    el,
